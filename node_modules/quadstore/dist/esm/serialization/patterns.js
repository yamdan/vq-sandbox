...
import { blankNodeWriter, defaultGraphWriter, genericLiteralWriter, langStringLiteralWriter, namedNodeWriter, numericLiteralWriter, stringLiteralWriter } from './terms.js';
...
export const writePattern = (pattern, index, prefixes) => {
    let gt = index.prefix;
    let lt = index.prefix;
    let gte = true;
    let lte = true;
